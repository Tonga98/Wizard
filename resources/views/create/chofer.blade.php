...
@section('content')
    ...
    <div class="flex justify-center mx-4">
        <div class="w-full mt-6 px-6 py-4 bg-white shadow-md overflow-hidden rounded-lg">
            <h2 class="font-semibold text-3xl tracking-wider">Añadir chofer</h2>
            <form method="POST" action="{{ route('chofer.store') }}" enctype="multipart/form-data" class="flex justify-between my-4">
                @csrf
                <!--Left side-->
                ...
                <div class="flex flex-col gap-2 mx-auto tracking-wide">
                    ...
                    <div>
                        ...
                        <x-text-input id="lic_conducir_venc" class="w-full" type="date" name="lic_conducir_venc" :value="old('lic_conducir_venc')" required autofocus autocomplete="lic_conducir_venc" />
                    ...
                    <div>
                        ...
                        <x-text-input id="linti_venc" class="w-full" type="date" name="linti_venc" :value="old('linti_venc')" required autocomplete="linti_venc" />
